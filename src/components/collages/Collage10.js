...
function Collage10() {
    ...
    const inputs = [
        ...
        {
            label: "Image6",
            handler: (e) => onImageChange1(e, setImg6)
        },
        {
            label: "Image7",
            handler: (e) => onImageChange1(e, setImg7)
        },
        {
            label: "Image8",
            handler: (e) => onImageChange1(e, setImg8)
        },
        {
            label: "Image9",
            handler: (e) => onImageChange1(e, setImg9)
        },
        {
            label: "Image10",
            handler: (e) => onImageChange1(e, setImg10)
        }
    ]
    ...
    return (
        <div className="mx-3 my-4 grid justify-center">
            <div className="grid grid-cols-5 space-4 my-5 gap-4 place-self-center">
                {inputs.map(item => {
                    return (
